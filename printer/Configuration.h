 ...
 */
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 4000, 565.88 } //{ gt2,gt2,M5 thread screw,hayena}
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 145.5 }//{ gt2,gt2,8m lead screw 8mm/rev,MK8}
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 2650, 145.5 }//{ gt2,gt2,M8 1.25mm/rev,MK8}
// e_steps_per_mm = (motor_steps_per_rev x driver_microstep) x (big_gear_teeth / small_gear_teeth) / (hob_effective_diameter x pi) 
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define G26_MESH_VALIDATION   // Enable G26 mesh validation
    ...
    #define MESH_TEST_HOTEND_TEMP   255.0   // (°C) Default nozzle temperature for the G26 Mesh Validation Tool.
